...
You usually don't use it directly — [`@arelts/active-record`](../active-record) does. Reach for `arel` when you need to compose SQL that the high-level API doesn't cover.
...
```ts
import { Arel, Visitors } from '@arelts/arel';
